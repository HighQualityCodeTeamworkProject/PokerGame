...
//        int pCall = 0, bot1Call = 0, bot2Call = 0, bot3Call = 0, bot4Call = 0, bot5Call = 0,
//            pRaise = 0, b1Raise = 0, b2Raise = 0, b3Raise = 0, b4Raise = 0, b5Raise = 0;
...
//                    "Assets\\Cards\\15.png","Assets\\Cards\\27.png"};#1#
...
//                    if (bot1Turn)
//                    {
//                        FixCall(b1Status, ref bot1Call, ref b1Raise, 1);
//                        FixCall(b1Status, ref bot1Call, ref b1Raise, 2);
//                        Rules(2, 3, "Bot 1", ref b1Type, ref b1Power, B1Fturn);
//                        MessageBox.Show("Bot 1's Turn");
//                        AI(2, 3, ref bot1Chips, ref bot1Turn, ref B1Fturn, b1Status, 0, b1Power, b1Type);
//                        turnCount++;
//                        last = 1;
//                        bot1Turn = false;
//                        bot2Turn = true;
...
//                    if (bot2Turn)
//                    {
//                        FixCall(b2Status, ref bot2Call, ref b2Raise, 1);
//                        FixCall(b2Status, ref bot2Call, ref b2Raise, 2);
//                        Rules(4, 5, "Bot 2", ref b2Type, ref b2Power, B2Fturn);
//                        MessageBox.Show("Bot 2's Turn");
//                        AI(4, 5, ref bot2Chips, ref bot2Turn, ref B2Fturn, b2Status, 1, b2Power, b2Type);
//                        turnCount++;
//                        last = 2;
//                        bot2Turn = false;
//                        bot3Turn = true;
...
//                    if (bot3Turn)
//                    {
//                        FixCall(b3Status, ref bot3Call, ref b3Raise, 1);
//                        FixCall(b3Status, ref bot3Call, ref b3Raise, 2);
//                        Rules(6, 7, "Bot 3", ref b3Type, ref b3Power, B3Fturn);
//                        MessageBox.Show("Bot 3's Turn");
//                        AI(6, 7, ref bot3Chips, ref bot3Turn, ref B3Fturn, b3Status, 2, b3Power, b3Type);
//                        turnCount++;
//                        last = 3;
//                        bot3Turn = false;
//                        bot4Turn = true;
...
//                    if (bot4Turn)
//                    {
//                        FixCall(b4Status, ref bot4Call, ref b4Raise, 1);
//                        FixCall(b4Status, ref bot4Call, ref b4Raise, 2);
//                        Rules(8, 9, "Bot 4", ref b4Type, ref b4Power, B4Fturn);
//                        MessageBox.Show("Bot 4's Turn");
//                        AI(8, 9, ref bot4Chips, ref bot4Turn, ref B4Fturn, b4Status, 3, b4Power, b4Type);
//                        turnCount++;
//                        last = 4;
//                        bot4Turn = false;
//                        bot5Turn = true;
...
//                    if (bot5Turn)
//                    {
//                        FixCall(b5Status, ref bot5Call, ref b5Raise, 1);
//                        FixCall(b5Status, ref bot5Call, ref b5Raise, 2);
//                        Rules(10, 11, "Bot 5", ref b5Type, ref b5Power, B5Fturn);
//                        MessageBox.Show("Bot 5's Turn");
//                        AI(10, 11, ref bot5Chips, ref bot5Turn, ref B5Fturn, b5Status, 4, b5Power, b5Type);
//                        turnCount++;
//                        last = 5;
//                        bot5Turn = false;
//                    }
...
//                        Holder[j].Image = Deck[j];
//                        pCall = 0; pRaise = 0;
//                        bot1Call = 0; b1Raise = 0;
//                        bot2Call = 0; b2Raise = 0;
//                        bot3Call = 0; b3Raise = 0;
//                        bot4Call = 0; b4Raise = 0;
//                        bot5Call = 0; b5Raise = 0;
//                    }
//                }
//            }
//            if (rounds == Turn)
...
//            b1Type = -1; b2Type = -1; b3Type = -1; b4Type = -1; b5Type = -1;
//            bot1Turn = false; bot2Turn = false; bot3Turn = false; bot4Turn = false; bot5Turn = false;
...
//            pCall = 0; bot1Call = 0; bot2Call = 0; bot3Call = 0; bot4Call = 0; bot5Call = 0; pRaise = 0; b1Raise = 0; b2Raise = 0; b3Raise = 0; b4Raise = 0; b5Raise = 0;
